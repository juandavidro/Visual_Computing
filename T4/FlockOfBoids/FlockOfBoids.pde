...
void setup() {
  ...
  //draw boid
    ...
    //strokeWeight(2);
    fish.stroke(color(255, 153, 0));
    fish.fill(color(255, 153, 0));


    fish.vertex(3 * sc, 0, 0);
    fish.vertex( 0, 1.5 * sc, 0);
    fish.vertex( 0, 0, 0.5 * sc);
    ...
    //--------cola-----------
     fish.vertex(-3 * sc, 0, 0);
     fish.vertex(-3.4 * sc, 0, 0);
     fish.vertex( -3.4 * sc, 2 * sc, -0.5 * sc);
    ...
    //--------aleta1-----------
     fish.vertex(0, 0, 0.5 * sc);
     fish.vertex( 0, 0.5 * sc, 3.5);
     fish.vertex( 0, -0.5 * sc, 3.5);

     fish.vertex(0, 0, 0.5 * sc);
     fish.vertex( 0, 0.5 * sc, 3.5);
     fish.vertex( 1 * sc, 0.5 * sc, 3.5);

     fish.vertex(0, 0, 0.5 * sc);
     fish.vertex( 0, -0.5 * sc, 3.5);
     fish.vertex( -1 * sc, -0.5, 3.5);
